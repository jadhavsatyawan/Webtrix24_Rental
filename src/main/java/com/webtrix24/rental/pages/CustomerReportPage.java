...
public class CustomerReportPage extends BasePage {
	...
	// Customer Report page title
	@FindBy(xpath = "//h1[contains(text(),'Customer Equipment Report')]")
	WebElement customerReportTitle;
	// private By customerReportTitle = By.xpath("//h1[contains(text(),'Customer
	// Equipment Report')]");
	...
	public boolean isCustomerReportOpened() {
		try {
			return wait.until(ExpectedConditions.visibilityOf(customerReportTitle)).isDisplayed();
		} catch (Exception e) {
			return false;
		}
	}
